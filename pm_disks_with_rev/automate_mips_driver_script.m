...
%%%% of rate constant \beta. The speeds are drawn from a uniform
%%%% distribution in the interval [-U_0,+U_0].
%%%% With directional reversals.
%%%%
%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
bet=[500.*D_r(1)]; %rate constant for Poisson process, speed fluctuation
...
for i=1:num_d_r
    for j=1:num_bet
        ...
        [pos] = function_for_sim_unif(L,N,v0,D_r(i),...
        				pos,theta,...
